  ...
  <div style="display: flex;flex-direction:column">
    <div style="margin-top: 20px">
      ...
      <div class="float-right" >
        <book-edit-modal @refreshBook="refreshBook"  showType="button" v-if="bookCreate"></book-edit-modal>
      </div>
      <div>
            ...
            <div class="list-col" style="width:100px">
              <div class="list-col-text" >
                ...
                <div v-if="item.state!=2">
                  ...
                  />
                  <a-icon class="icon-style" type="frown" @click="()=>setLost(item.id)" title="丢失" />
                </div>
              </div>
            </div>
          </div>
      ...
      reqGetBookPaged({
        ...
        .then(response => {
          ...
          for (let i = 0; i < items.length; i++) {
            ...
            if (
              items[i].lastModifierUserId == this.$store.state.userInfo.userId
            ) {
              _this.hasBorrow = true;
            }
          }
